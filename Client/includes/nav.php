    ...
    <div class="container" >
        <div class="navbar-header">
            ...
            <!-- <a class="navbar-brand" href="index.php"><b style="font-size:20px;color:white"> O.D.F</b></a>-->
                  <a class="navbar-brand" href="index.php"><b style="font-size:19px;color:white">Online Discussion Forum </b>For Students </a>
        </div>
...
?>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="answer.php"><span class="glyphicon glyphicon-edit"></span> Add Answers </a></li>
